<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @can('role-U')
                <div class="bg-red-500 overflow-hidden shadow-sm sm:rounded-lg mb-5">
                    <div class="p-6 text-gray-900">
                        User
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Porro sapiente dolor nisi vitae sunt cum
                        enim animi fugit et ex, possimus molestias distinctio ipsam repudiandae optio vel eligendi mollitia
                        quam ratione aut. Nulla ab ut hic magni porro reprehenderit quidem at sint mollitia excepturi
                        officia tenetur, vitae aliquid. Voluptatem totam non ipsam voluptates cum quos nobis iste ratione
                        aliquid saepe, eaque necessitatibus, dolorum est numquam. Autem aspernatur illum temporibus eveniet
                        ipsa distinctio, magni adipisci, inventore eligendi excepturi ratione dolorum illo at, reprehenderit
                        ullam iure id! Consequatur, architecto minus, molestias nam laboriosam veritatis illum quasi sequi
                        repudiandae voluptas voluptatem, porro necessitatibus.
                    </div>
                </div>
            @elsecan('role-A')
                                ...
                                <div class="flex flex-col h-full">
                                    ...
                                    @can('role-U')
                                        <p>
                                            ...
                                            dolor nisi vitae sunt cum
                                            enim animi fugit et ex, possimus molestias distinctio ipsam repudiandae
                                            optio vel eligendi mollitia
                                            quam ratione aut.
                                        </p>
                                    @elsecan('role-A')
                                        <p>
                                            ...
                                            enim animi fugit et ex, possimus molestias distinctio ipsam repudiandae
                                            optio vel eligendi mollitia
                                            quam ratione aut. Nulla ab ut hic magni porro reprehenderit quidem at sint
                                            mollitia excepturi
                                            officia tenetur, vitae aliquid. Voluptatem totam non ipsam voluptates cum
                                            quos nobis iste ratione
                                            aliquid saepe, eaque necessitatibus, dolorum est numquam. Autem aspernatur
                                            illum temporibus eveniet
                                            ipsa distinctio, magni adipisci, inventore eligendi excepturi ratione
                                            dolorum illo at, reprehenderit
                                            ullam iure id! Consequatur, architecto minus, molestias nam laboriosam
                                            veritatis illum quasi sequi
                                            repudiandae voluptas voluptatem, porro necessitatibus.
                                        </p>
                                    @endcan

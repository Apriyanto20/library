<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-100 p-6 rounded-lg">
                        <h3 class="text-lg font-semibold mb-4">Form Tambah Major</h3>
                        <form action="{{ route('major.store') }}" method="POST">
                            @csrf
                            <div class="my-5">
                                <label for="kode_major"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    Kode Major</label>
                                <input type="text" id="kode_major" name="kode_major"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="" value="{{ $kode_major }}" readonly required />
                            </div>
                            <div class="mb-5">
                                <label for="fakultas"
                                ...
                                <select
                                    ...
                                    @foreach ($fakultas as $j)
                                        <option value="{{ $j->kode_fakultas }}">{{ $j->fakultas }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" id="major" name="major"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Masukan Nama Major" required autofocus />
                            </div>
                            <button type="submit"
                    ...
                    <!-- Data Section -->
                    <div class="bg-gray-100 p-6 rounded-lg">
                        <h3 class="text-lg font-semibold mb-4">Data Major</h3>
            ...
            <div class="w-full md:w-1/2 relative bg-white rounded-lg shadow mx-5">
                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        <div class="mb-5">
                            <label for="kode_major"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Major
                                <span class="text-red-500">*</span></label>
                            <input type="text" id="kode_major_edit" name="kode_major"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukan Kode Major...." />
                            <span class="text-sm m-l text-red-500">{{ $errors->first('kode_major') }}</span>
                        </div>
                        <div class="mb-5">
                            <label for="major"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Major
                                <span class="text-red-500">*</span></label>
                            <input type="text" id="nm_major" name="major"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukan majoran...." />
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#major-datatable').DataTable({
                ...
                initComplete: function() {
                    ...
                    $('#major-datatable thead th').css('text-align', 'center');
                },
                columns: [{
                    data: 'no',
                    ...
                    render: (data, type, row) => {
                        let editUrl =
                            `<button type="button" data-id="${data.id}"
                                                        data-modal-target="sourceModal" data-kode_major="${data.kode_major}" data-name="${data.major}"
        ...
        const editSourceModal = (button) => {
            ...
            const kode_major = button.dataset.kode_major;
            ...
            major ${name}`;
            document.getElementById('kode_major_edit').value = kode_major;
            document.getElementById('nm_major').value = name;
        ...
        const majorDelete = async (id, name) => {
